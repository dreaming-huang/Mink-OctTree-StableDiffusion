...
if __name__ == "__main__":
    ...
    pa.add_argument("--modelnet40_path", type=str, default="/mnt/data4/hjm_code_4/MinkowskiEngine-master/data/ModelNet40", help="clip_path")
    pa.add_argument("--shapenet_path", type=str, default="/mnt/data4/hjm_code_4/MinkowskiEngine-master/data/ShapeNetCore.v2_only_obj", help="clip_path")
